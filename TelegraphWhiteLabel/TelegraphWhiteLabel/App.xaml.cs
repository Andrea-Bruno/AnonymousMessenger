...
namespace AnonymousWhiteLabel
{
    public partial class App : Application
    {
        ...
        public void Start(string passPhrase)
        {
            ...
            Context = XamarinShared.Setup.Initialize(OnMessageArrived, OnNewMessageAddedToView, Config.Connection.EntryPoint, Config.Connection.NetworkName, Config.ChatUI.MultipleChatModes, Config.ChatUI.NewMessageOnTop, ChatPage.MessageContainer, OnInizialized: OnContextInitialized, privatKeyOrPassphrase: passPhrase);
