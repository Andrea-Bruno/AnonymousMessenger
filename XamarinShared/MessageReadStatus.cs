...
{
	/// <summary>
	/// This class deal with message read status, when a message is delievered or if the reciever has seen the message.
	/// </summary>
	public class MessageReadStatus
	{
		...
		/// <param name="SendNotificationToChannel"></param>
		/// <param name="flagAndTime"></param>
		/// <returns></returns>
		...
		public class MessageStatus
		{
			...
			/// 
			/// </summary>
			/// <param name="lastMessageDelivered"></param>
