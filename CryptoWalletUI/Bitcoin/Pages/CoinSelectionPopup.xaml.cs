...
namespace CryptoWalletUI.Bitcoin.Views
{
    ...
    {
        private readonly BtcTransferService btcCommonService;
        public CoinSelectionPopup()
        {
            btcCommonService = BtcTransferService.Instance;
            InitializeComponent();
        }
        ...
        private void CollectionView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (((CollectionView)sender).SelectedItems != null)
                btcCommonService.SelectedUnspentCoins = ((CollectionView)sender).SelectedItems.Cast<UnspentCoin>().ToList();
        }
