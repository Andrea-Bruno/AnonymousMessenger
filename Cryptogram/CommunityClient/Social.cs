    ...
    public static class Social
    {
        ...
        public static void Initialize(Xamarin.Forms.Page mainPage, EncryptedMessaging.Context context)
        {
            ...
            if (CommunityCloud == null)
                CommunityCloud = Context.Contacts.AddContact(BaseCommunity.DefaultServerPublicKey, "CommunityCloud", true, EncryptedMessaging.Contacts.SendMyContact.None);
            ...
            Context.OnMessageBinaryCome.Add(CommunityCloud.ChatId, Communication.ProcessIncomingMessage); // Set the executor for incoming binary messages for this plug-in
#if DEBUG
            ...
            {
                n++;
                CreateNewCommunity(CommunityType.Group, "♥", "Test group " + n, "Community for test use " + n, Convert.FromBase64String(privateKey), context.Channell.ServerUri, modality: BaseCommunity.ModalitySubscription.NoSubscriptionRequired);
            }
            ...
            if (MyWall == null)
            {
                ...
                var myWall = new Wall();
                myWall.Initialize(null, context.My.Name, null, wallKey.ToBytes(), context.Channell.ServerUri);
                MyWall = myWall;
            }
